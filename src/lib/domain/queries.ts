...
function mapItem(row: Record<string, unknown>): Item {
  return {
    ...
    package_number: (row.package_number as string | null) ?? null,
    warehouse_number: (row.warehouse_number as string | null) ?? null,
    external_barcode: (row.external_barcode as string | null) ?? null,
    ...
    italy_location: (row.italy_location as string | null) ?? null,
    uk_location: (row.uk_location as string | null) ?? null,
    packing: (row.packing as string | null) ?? null,
    picked: (row.picked as string | null) ?? null,
    loaded: (row.loaded as string | null) ?? null,
